...
/***/ (function(module, exports, __webpack_require__) {
	...
	var noteEvents = __webpack_require__(13);
	$(function () {
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://infinite-tundra-20530.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('#sign-out-navbar').on('click', onSignOut);
	};
	module.exports = {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(9);
	var notesUI = __webpack_require__(12);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getUsersNotes = function getUsersNotes() {
	  // console.log('getUsersNotes called')
	  api.retrieveUserNotes().then(events.getUserNotesSuccess).catch(events.getUserNotesFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(9);
	var noteListTemplate = __webpack_require__(14);
	var note = __webpack_require__(34);
	var api = __webpack_require__(35);

	var getUserNotesSuccess = function getUserNotesSuccess(data) {
	  ...
	  if (data.notes.length !== 0) {
	    ...
	    ();var showNoteListTemplate = noteListTemplate({ noteBranch: store.noteTree.noteBranch });
	    ...
	    // that was added in the handlebars template
	      ...
	      );api.onDeleteNote(data[2]).then(onDeleteNoteSuccess).catch(onDeleteNoteFailure);
	    });
	...
	var onDeleteNoteSuccess = function onDeleteNoteSuccess() {
	  ...
	  api.retrieveUserNotes().then(getUserNotesSuccess).catch(getUserNotesFailure);
	};
	var onDeleteNoteFailure = function onDeleteNoteFailure(error) {
	  // console.log('onDeleteNoteFailure called', error)
	};
	var getUserNotesFailure = function getUserNotesFailure(error) {
	  // console.log('getUserNotesFailure failure', error)
	  console.error(error);
	};

	var clearNoteHiveModalParameters = function clearNoteHiveModalParameters() {
	...
	var onCreateNoteButton = function onCreateNoteButton(event) {
	...
	var createUserNoteSuccess = function createUserNoteSuccess() {
	...
	var updateUserNoteSuccess = function updateUserNoteSuccess() {
	...
	var updateUserNoteFailure = function updateUserNoteFailure(error) {
	  console.log('updateUserNoteSuccess called', error);
	};

	var createUserNoteFailure = function createUserNoteFailure(error) {
	...
	var onNoteNameClick = function onNoteNameClick(event) {
	...
	module.exports = {
	  getUserNotesSuccess: getUserNotesSuccess,
	  getUserNotesFailure: getUserNotesFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <h4 id=\"note-branch\" class='highlight note-hive-name'>Notes for: "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.name : depth0), depth0))
	    + "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.notes : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</h4>\n";
	  ...
	  return "    <ul data-id=\""
	    ...
	    + "\" class='note-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + " list-unstyled note-toggle no-unline'>\n      <li>Observation Date: "
	    + alias2(alias1((depth0 != null ? depth0.observation_date : depth0), depth0))
	    + "</li>\n      <li>Notes: "
	    + alias2(alias1((depth0 != null ? depth0.observe : depth0), depth0))
	    + "</li>\n      <li>Task: "
	    + alias2(alias1((depth0 != null ? depth0.task : depth0), depth0))
	    + "</li>\n      <li>Task Due Date: "
	    + alias2(alias1((depth0 != null ? depth0.task_due_date : depth0), depth0))
	    + "</li>\n      <li>Task Status: "
	    + alias2(alias1((depth0 != null ? depth0.task_status : depth0), depth0))
	    + "</li>\n      <div>\n        <p>\n          <button type=\"button\" class=\"btn btn-default btn-sm delete-note\" name=\"button\" id=\"button-delete-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n            <span class=\"glyphicon glyphicon-trash\"></span> Delete\n          </button>\n          <button type=\"button\" class=\"btn btn-default btn-sm update-note\" name=\"button\" id=\"button-update-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	  ...
	  return "<div id=\"accordion\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.noteBranch : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var validateNoteData = function validateNoteData() {
	  // console.log('validateNoteData called')
	  var name = $('#name').val();
	  var notedate = $('#notedate').val();
	  var observation = $('#observe').val();
	  var futuretask = $('#futuretask').val();
	...
	var updateFormWithNoteData = function updateFormWithNoteData(id) {
	  var data = findNoteByID(id
	...
	var findNoteByID = function findNoteByID(idMatch) {
	  var result = void 0;
	  var i = void 0;
	  for (i in store.notes) {
	    var id = store.notes[i].id;
	    if (id == idMatch) {
	...
	var noteCreate = {
	...
	};var createNoteTree = function createNoteTree() {
	  // empty noteTree to start
	  // store.noteTree.noteBranch = []
	  noteTree.noteBranch = [];
	  noteBranch.notes = [];
	  var hiveName = store.notes[0].hive_name;
	  var name = store.notes[0].hive_name;
	  var currentBranch = noteBranch;
	  var branchedSaved = false;
	  ...
	  for (i in store.notes) {
	    ...
	    if (name === hiveName) {
	      ...
	      // make a copy to save
	      var data = JSON.parse(JSON.stringify(currentBranch));
	  ...
	  if (!branchedSaved) {
	    var _data = JSON.parse(JSON.stringify(currentBranch));
	    noteTree.noteBranch.push(_data);
	  }
	...
	// }
	module.exports = {
	  validateNoteData: validateNoteData,
	  updateFormWithNoteData: updateFormWithNoteData,
	  createNoteTree: createNoteTree
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var retrieveUserNotes = function retrieveUserNotes() {
	...
	var createUserNote = function createUserNote(data) {
	...
	var onDeleteNote = function onDeleteNote(id) {
	...
	var updateUserNote = function updateUserNote(data, id) {
	...
	module.exports = {
	  retrieveUserNotes: retrieveUserNotes,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "1b6f5c6300b5ff88e600ec6232f082b8.jpg";
